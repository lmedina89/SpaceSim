...
if (!html.includes('Universe Lab v0.1.4.6.1.3')) throw new Error('Shell version is not v0.1.4.6.1.3.');
if (!html.includes('FRAMECTRL-14613')) throw new Error('FRAMECTRL-14613 build marker missing.');
if (pkg.version !== '0.1.4.6.1.3') throw new Error('package.json version mismatch.');
...
if (versionJson.buildMarker !== 'FRAMECTRL-14613') throw new Error('VERSION.json build marker mismatch.');
