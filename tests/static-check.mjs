...
if (!html.includes('Universe Lab v0.1.4.6.1.1')) throw new Error('Shell version is not v0.1.4.6.1.1.');
if (!html.includes('COCKPIT-14611')) throw new Error('COCKPIT-14611 build marker missing.');
if (pkg.version !== '0.1.4.6.1.1') throw new Error('package.json version mismatch.');
...
if (versionJson.buildMarker !== 'COCKPIT-14611') throw new Error('VERSION.json build marker mismatch.');
