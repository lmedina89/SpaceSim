...
if (!html.includes('Universe Lab v0.1.3.1')) throw new Error('Shell version is not v0.1.3.1.');
if (pkg.version !== '0.1.3.1') throw new Error('package.json version mismatch.');
