...
if (!html.includes('Universe Lab v0.1.4.6.1.3.1')) throw new Error('Shell version is not v0.1.4.6.1.3.1.');
if (!html.includes('MFDENG-146131')) throw new Error('MFDENG-146131 build marker missing.');
if (pkg.version !== '0.1.4.6.1.3.1') throw new Error('package.json version mismatch.');
...
if (!html.includes('./styles.css?v=146131') || !html.includes('./src/main.js?v=146131')) throw new Error('Build-version cache-busting tags missing.');
...
if (!main.includes("./app/app.js?v=146131")) throw new Error('Main-to-app cache-busting import missing.');
if (!app.includes("../render/threeRenderer.js?v=146131") || !app.includes("../ui/hud.js?v=146131")) throw new Error('App cache-busting imports missing.');
if (!renderer.includes("./cockpitView.js?v=146131")) throw new Error('Cockpit renderer cache-busting import missing.');
...
if (versionJson.buildMarker !== 'MFDENG-146131') throw new Error('VERSION.json build marker mismatch.');
