...
if (!html.includes('Universe Lab v0.1.1.3')) throw new Error('Shell version is not v0.1.1.3.');
if (pkg.version !== '0.1.1.3') throw new Error('package.json version mismatch.');
