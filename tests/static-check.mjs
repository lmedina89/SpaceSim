...
const required = [
  ...
  'src/physics/trajectoryPredictor.js','src/physics/shipDynamics.js','src/physics/flightComputer.js','src/physics/transitDrive.js','src/physics/frameOrbitInsertion.js','src/physics/impactResolver.js',
...
if (!html.includes('Universe Lab v0.1.4.8')) throw new Error('Shell version is not v0.1.4.8.');
if (!html.includes('NAVSYS-148')) throw new Error('NAVSYS-148 build marker missing.');
if (pkg.version !== '0.1.4.8') throw new Error('package.json version mismatch.');
...
if (!html.includes('./styles.css?v=148') || !html.includes('./src/main.js?v=148')) throw new Error('Build-version cache-busting tags missing.');
...
if (!main.includes("./app/app.js?v=148")) throw new Error('Main-to-app cache-busting import missing.');
if (!app.includes("../render/threeRenderer.js?v=148") || !app.includes("../ui/hud.js?v=148")) throw new Error('App cache-busting imports missing.');
if (!renderer.includes("./cockpitView.js?v=148")) throw new Error('Cockpit renderer cache-busting import missing.');
...
if (versionJson.buildMarker !== 'NAVSYS-148') throw new Error('VERSION.json build marker mismatch.');
...
if (!String(versionJson.landabilityFoundation || '').includes('gas giants') || !String(versionJson.landabilityFoundation || '').includes('unmodeled')) throw new Error('VERSION.json landability foundation missing.');
