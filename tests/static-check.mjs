...
if (!html.includes('Universe Lab v0.1.4.6.1.2')) throw new Error('Shell version is not v0.1.4.6.1.2.');
if (!html.includes('DIAGMFD-14612')) throw new Error('DIAGMFD-14612 build marker missing.');
if (pkg.version !== '0.1.4.6.1.2') throw new Error('package.json version mismatch.');
...
if (versionJson.buildMarker !== 'DIAGMFD-14612') throw new Error('VERSION.json build marker mismatch.');
