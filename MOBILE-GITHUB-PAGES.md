# Mobile GitHub Pages deployment — Universe Lab v0.1.3.1
...
1. Extract the ZIP.
2. Copy/upload the extracted contents directly into the repository root. Do not create an extra `UniverseLab-v0.1.3.1/` wrapper in the repository.
...
## iPhone release gate for v0.1.3.1

After deployment, verify:

- HUD reports **v0.1.3.1** and WebGPU/WebGL2 backend,
