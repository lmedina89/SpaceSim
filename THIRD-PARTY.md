...
Universe Lab v0.1.4.4 uses **Three.js 0.185.0**, imported from the pinned jsDelivr module URLs in `index.html` / the import map.
...
No third-party weather, terrain, spacecraft or anomaly art assets were added in v0.1.4.4; these visuals are generated from Three.js primitives, canvas textures and seeded procedural data.
